...
$repo = "cobalt-ops-cleanup-deck"
$language = "JavaScript"
$category = "Automation"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/cobalt-ops-cleanup-walkthrough.md")) {
